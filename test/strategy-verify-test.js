...
describe('Strategy', function () {
    ...
    before(function () {
        ...
        Strategy.JwtVerifier.callsArgWith(3, null, test_data.valid_jwt);
    });
    ...
    describe('Handling a request with a valid JWT and succesful verification', function () {
        ...
        before(function (done) {
            strategy = new Strategy({ jwtFromRequest: extract_jwt.fromAuthHeader(), clientID: 'clientID', secretOrKey: 'secret' }, function (jwt_paylod, next) {
    ...
    describe('handling a request with valid jwt and failed verification', function () {
        ...
        before(function (done) {
            strategy = new Strategy({ jwtFromRequest: extract_jwt.fromAuthHeader(), clientID: 'clientID', secretOrKey: 'secret' }, function (jwt_payload, next) {
    ...
    describe('handling a request with a valid jwt and an error during verification', function () {
        ...
        before(function (done) {
            strategy = new Strategy({ jwtFromRequest: extract_jwt.fromAuthHeader(), clientID: 'clientID', secretOrKey: 'secrety' }, function (jwt_payload, next) {
