 ...
 *          jwtFromRequest: String contains where the application should find for that authorization token (header, bodyfield, queryparameter, authheader)
 *          authScheme: Used when
